...
namespace WebApi.Migrations
{
    ...
    [Migration("20221106195313_IdentityFix")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebApi.Auth.Model.ERPUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("WebApi.Auth.Model.ERPUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("WebApi.Data.Entities.Work", b =>
                {
                    ...
                    b.HasOne("WebApi.Auth.Model.ERPUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
